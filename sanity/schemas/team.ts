...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "string",
      description: "The qualifications or certifications of the team member.",
      validation: (Rule) => Rule.required(),
    }),
    defineField({
      name: "bio",
      ...
      fields: [
        {
          ...
          description: "A descriptive alternative text for the image.",
          validation: (Rule) => Rule.required(),
        },
      ],
      group: "media",
    ...
    defineField({
      ...
      type: "url",
      group: "social",
      description: "The team member's personal or professional website URL.",
    }),
    defineField({
      name: "email",
      title: "Email",
